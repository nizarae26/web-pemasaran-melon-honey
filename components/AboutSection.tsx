...
export default function AboutSection() {
  return (
    <section className="py-17 px-4 bg-poktan-accent/40">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="order-1 md:order-2">
          ...
          <Link 
            href="/profil" 
            className="mt-8 inline-flex items-center justify-center gap-2 bg-poktan-leaf hover:bg-poktan-green text-white px-8 py-3.5 rounded-full font-bold shadow-lg shadow-poktan-leaf/25 transition-all duration-300 hover:scale-102 active:scale-95 text-sm w-fit group"
          >
        ...
        <div className="grid grid-cols-2 gap-4 order-2 md:order-1">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 text-center flex flex-col justify-center items-center group hover:shadow-md transition-all">
            <div className="w-12 h-12 bg-poktan-leaf rounded-xl flex items-center justify-center text-white mb-4 shadow-lg shadow-poktan-leaf/20 group-hover:scale-110 transition-transform">
              <Users size={24} strokeWidth={2.5} />
            </div>
            <p className="text-2xl font-black text-poktan-leaf tracking-tighter leading-none">
              10+
            </p>
