      ...
      <div className="relative z-10 w-full max-w-6xl px-8 md:px-20 flex flex-col justify-center h-full mt-4 md:mt-0">
        <div className="max-w-2xl">
          ...
          <div className="flex flex-wrap justify-start gap-3 mb-10 md:mb-12">
            <button className="bg-poktan-green px-6 py-3 rounded-full text-sm font-bold hover:scale-105 transition shadow-lg">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-6 border-t border-white/10 pt-6">
          ...
          <div className="flex items-center gap-3 group">
            ...
            <div className="w-11 h-11 bg-poktan-green rounded-xl shadow-lg shadow-emerald-500/20 flex items-center justify-center text-white transition-transform group-hover:scale-110">
